...
export default function WelcomeAuthOverlay({
  ...
  if (isAuthQuiz) {
    ...
    modalSubtitle = isAr
      ? `صناعة وتوليد أسئلة الاختبارات بمحركات الذكاء الاصطناعي التوليدي متاحة مجاناً بحسابك لحفظ إبداعاتك ومشاركتها مع متميزي العالم.`
      : `Designing and generating quizzes from images with AI is free and requires authenticating to preserve your workspace resources.`;
  } else {
    modalHeading = isAr
