...
import { getDirectMessages, sendDirectMessage, markMessagesAsRead, COSMO_ADMIN_UID } from '../lib/db';
...
export default function HeaderMessages({ userId, userName, lang }: HeaderMessagesProps) {
  ...
  const defaultAdmin = {
    uid: COSMO_ADMIN_UID,
    name: isAr ? 'المساعد مساعد الذكاء الاصطناعي' : 'Assistant AI',
                      ...
                      {activeConv && activeConv.messages.length > 0 ? (
                        ...
                        <div className="h-full flex flex-col items-center justify-center text-center p-4 space-y-2">
                          ...
                          <p className="text-xs text-slate-500 dark:text-slate-400 font-bold max-w-[80%] leading-relaxed">
                            {isAr 
                              ? 'اكتب رسالتك بالأسفل لطلب الدعم والمساعدة والتحدث مع المساعد الذكي مساعد الذكاء الاصطناعي!' 
                              : 'Type your message below for promo codes or real-time support from AI AI Assistant!'
                            }
                          </p>
                        </div>
                      )}
                      ...
                      <div className="h-full flex flex-col items-center justify-center text-center p-6 space-y-4">
                        ...
                        <div className="space-y-1.5 max-w-[85%]">
                          ...
                          <p className="text-[10px] text-slate-400 dark:text-slate-500 font-bold leading-relaxed">
                            {isAr 
                              ? 'تواصل مع المساعد الذكي مساعد الذكاء الاصطناعي لطلب الدعم الفني أو الاستفسارات الأكاديمية!' 
                        ...
                        >
                          ...
                          <span>{isAr ? 'مراسلة مساعد الذكاء الاصطناعي فوراً 💬' : 'Contact AI 💬'}</span>
                        </button>
                      </div>
                    )}
                  </div>
