            ...
            {isDownloading ? (
              ...
              <div className="py-10 text-center space-y-6">
                ...
                <div className="space-y-1.5 max-w-xs mx-auto">
                  ...
                  <p className="text-xs text-slate-400">
                    {isAr ? 'يتيح لك مساعد الذكاء الاصطناعي الوصول الآمن لمستنداتك ومناهجك بصيغ PDF والصور لبدء تحويلها فوراً لمسابقات ذكية.' : 'Authorizes Quiz Space to securely pull your PDF books, exam sheets, and study materials.'}
                  </p>
                </div>
