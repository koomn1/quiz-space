...
export default function AdminSubscriptions({
  ...
  const handleSaveCoupon = async () => {
    ...
    try {
      ...
      showToast('error', isAr ? `فشل حفظ الكوبون: ${detail}` : `Coupon save failed: ${detail}`);
    }
  };
    ...
    try {
      ...
      const messagesToInsert = usersData
        ...
        .map(u => ({
          ...
          sender_name: isAr ? 'المساعد سبارك' : 'Spark Assistant',
      ...
      await createCommunityPost(
        aiPromoMsg,
        COSMO_ADMIN_UID,
        isAr ? 'المساعد سبارك' : 'Spark Assistant',
        '🤖',
        '#8b5cf6'
      );
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2 text-violet-300">
                  ...
                  <h4 className="font-extrabold text-base">
                    {isAr
                      ? "الرسالة الترويجية المقترحة من سبارك 🤖"
