                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-slate-400 mt-1">{isAr ? 'حل كويزات المعلم المباشرة أو اطلب من مساعد الذكاء الاصطناعي توليد مسودة اختبار فوري.' : 'Solve assigned tests or prompt AI AI to generate a quiz draft.'}</p>
                    </div>
              ...
              {activeWorkspaceTab === 'analytics' && (
                <div className="space-y-6">
                  ...
                  <div className="p-5 rounded-2xl bg-purple-950/20 border border-purple-500/20 flex gap-4 items-start">
                    ...
                    <div className="space-y-1">
                      <h5 className="text-xs font-bold text-white">{isAr ? 'ملاحظة مساعد الذكاء الاصطناعي للذكاء الاصطناعي الأكاديمي' : 'AI AI Pedagogical Feedback'}</h5>
      ...
      {isAiQuizOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-50 flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 max-w-sm w-full space-y-4">
            <h5 className="font-bold text-white text-sm">{isAr ? 'توليد اختبار ذكي بالذكاء الاصطناعي مساعد الذكاء الاصطناعي' : 'Generate Smart Quiz Draft via AI AI'}</h5>
            <p className="text-xs text-slate-400">{isAr ? 'اكتب الموضوع أو المفهوم التعليمي وسيقوم مساعد الذكاء الاصطناعي بصياغة اختبار متكامل مع مفتاح الإجابات.' : 'Prompt AI AI to compile questions on your selected curriculum topic.'}</p>
            <input 
              type="text" 
