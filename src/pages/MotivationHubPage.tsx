    ...
    <div className="space-y-6">
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <div className="rounded-3xl border border-violet-200 bg-gradient-to-br from-violet-50 to-indigo-100 p-5 dark:border-violet-900/50 dark:from-violet-950/30 dark:to-indigo-950/20">
          <div className="mb-4 flex items-center justify-between"><span className="flex h-12 w-12 items-center justify-center overflow-hidden rounded-2xl bg-white/80 shadow-sm dark:bg-slate-900/50"><img src={imageUrl('mystery_box-tiny')} alt="" width="48" height="48" loading="lazy" className="h-full w-full object-cover" /></span><span className="text-xs font-black text-violet-700 dark:text-violet-300">{lang === 'ar' ? 'مكافآت اليوم' : "Today's rewards"}</span></div>
        ...
        <div className="rounded-3xl border border-sky-200 bg-gradient-to-br from-sky-50 to-cyan-100 p-5 dark:border-sky-900/50 dark:from-sky-950/30 dark:to-cyan-950/20">
          <div className="mb-4 flex items-center justify-between"><span className="flex h-12 w-12 items-center justify-center overflow-hidden rounded-2xl bg-white/80 shadow-sm dark:bg-slate-900/50"><img src={imageUrl('weekly_achievement-tiny')} alt="" width="48" height="48" loading="lazy" className="h-full w-full object-cover" /></span><span className="text-xs font-black text-sky-700 dark:text-sky-300">{lang === 'ar' ? 'رصيدك الحالي' : 'Your balance'}</span></div>
