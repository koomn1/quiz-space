                          ...
                          <button 
                            ...
                            onClick={async () => {
                              ...
                              try {
                                ...
                                alert(isAr ? `تم إرسال العرض بنجاح وبدأت كوزمو بإرسال الرسائل لجميع الـ ${allUsers.length} مستخدمين!` : `Offer sent successfully, AI is messaging all ${allUsers.length} users!`);
                                setPromoCode('');
                                setPromoMessage('');
                              } catch (err) {
