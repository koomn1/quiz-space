                          ...
                          <button 
                            ...
                            onClick={async () => {
                              ...
                              try {
                                  ...
                                  if (user.userId && user.userId !== 'anonymous') {
                                    try {
                                      await sendDirectMessage(
                                        COSMO_SYSTEM_UID,
                                        isAr ? 'مساعد الذكاء الاصطناعي 🤖' : 'AI 🤖',
                                        user.userId,
                                        user.name || 'Student',
                                ...
                                alert(isAr ? `تم إرسال العرض بنجاح وبدأت مساعد الذكاء الاصطناعي بإرسال الرسائل لجميع الـ ${allUsers.length} مستخدمين!` : `Offer sent successfully, AI is messaging all ${allUsers.length} users!`);
                                setPromoCode('');
                                setPromoMessage('');
                              } catch (err) {
