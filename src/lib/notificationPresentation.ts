...
const rewardTypes = new Set(['weekly_task', 'daily_challenge', 'daily_gift', 'lucky_spin', 'mystery_box', 'brain_challenge', 'admin_grant', 'reward', 'store_purchase']);
const learningTypes = new Set(['classroom', 'lesson', 'assignment', 'quiz', 'community']);
