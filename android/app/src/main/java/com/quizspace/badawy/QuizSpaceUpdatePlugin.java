...
public class QuizSpaceUpdatePlugin extends Plugin {
    ...
    public void enqueue(PluginCall call) {
        ...
        if (url == null || url.trim().isEmpty() || !isTrustedDownloadUrl(url.trim())) {
    ...
    private static boolean isTrustedDownloadUrl(String value) {
        try {
            ...
            return "github.com".equals(normalized) || "objects.githubusercontent.com".equals(normalized);
