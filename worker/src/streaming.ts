...
const OPENROUTER_VISION_FALLBACKS = ['google/gemma-4-31b-it:free', 'thinkingmachines/inkling-small:free', 'nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free', 'google/gemma-4-26b-a4b-it:free', 'dots-studio/dots-3-note-preview:free'];
