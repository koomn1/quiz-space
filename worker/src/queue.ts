...
export async function enqueueExtractionJob(env: Env, authHeader: string, jobId: string): Promise<void> {
...
export async function scheduleExtractionJob(env: Env, authHeader: string, jobId: string): Promise<void> {
  try {
